    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="">删除新闻信息</a></li>
            </ul>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h2 class="page-header">删除新闻</h2>
    <div>
        <%--style="position: relative; display: table-cell;text-align: center; vertical-align: middle"--%>
        <form class="form-signin" action="/news/deleteNews" style="width: 300px; align-content: center">
            <p class="text-danger">确定删除以下信息？</p>
            <div class="row">
                <h4>新闻ID</h4>
                <label for="id" class="sr-only"></label>
                <input readonly type="text" id="id" name="id" class="form-control"
                       value="${news.id}" required autofocus>
            </div>
            <div class="row">
                <h4>新闻标题</h4>
                <label for="newsTitle" class="sr-only"></label>
                <input readonly id="newsTitle" name="newsTitle" class="form-control" value="${news.newsTitle}"
                       required>
            </div>
            <div class="row">
                <h4>新闻摘要</h4>
                <label for="newsDigest" class="sr-only"></label>
                <input readonly id="newsDigest" name="newsDigest" class="form-control" value="${news.newsDigest}" required
                       autofocus>
            </div>
            <div class="row">
                <h4>新闻内容</h4>
                <label for="newsContent" class="sr-only"></label>
                <textarea readonly id="newsContent" name="newsContent" class="form-control" value=""
                          required>${news.newsContent}</textarea>
            </div>
            <div class="row">
                <h4>新闻时间</h4>
                <label for="newsTime" class="sr-only"></label>
                <input readonly id="newsTime" name="newsTime" class="form-control"
