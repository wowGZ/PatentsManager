    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li><a href="/patent/toAddPatent">添加专利信息<span class="sr-only">(current)</span></a></li>
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="/news/toAddNews">添加新闻</a></li>
            </ul>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div>
        ...
        <form class="form-signin" action="/news/addNews" style="width: 300px; align-content: center">
            <div class="row">
                <h4>新闻id</h4>
            ...
            <div class="row">
                ...
                <input id="newsTitle" name="newsTitle" class="form-control"
                       required>
            </div>
            <div class="row">
                <h4>新闻摘要</h4>
                <label for="newsDigest" class="sr-only"></label>
                <input id="newsDigest" name="newsDigest" class="form-control" required
                       autofocus>
            </div>
            ...
            <%--</div>--%>
            <br>
            <button class="btn btn-lg btn-primary btn-block" type="submit">确定添加</button>
